        ...
        <x-card class="p-10 rounded max-w-lg mx-auto mt-24">
            ...
            <form  action="{{ @route('update', $listing->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <input value="{{ $listing->location }}" type="text" class="border border-gray-200 rounded p-2 w-full" name="location"
                ...
                <div class="mb-6">
                    ...
                    <textarea class="border border-gray-200 rounded p-2 w-full"
                        name="description" rows="10" placeholder="Include tasks, requirements, salary, etc">{{ $listing->logo }} </textarea>
